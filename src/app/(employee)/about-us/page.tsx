    ...
    <div>
      ...
      <div className="max-w-7xl mx-auto px-6 2xl:px-0 mt-10">
        <p className="text-[#303D5C] text-[400] text-sm md:text-base lg:text-[20px] leading-[27px] md:leading-[33px] lg:leading-[36px] font-Poppins text-justify">
          ...
          “Med HR Plus” and all of its different versions including mobile
          applications, print material, social media posts, etc. https://medhrplus.com is
        ...
        <br />
        <p className="text-[#303D5C] text-[400] text-sm md:text-base lg:text-[20px] leading-[27px] md:leading-[33px] lg:leading-[36px] font-Poppins text-justify">
          Med HR Plus does not take any responsibilities on behalf of any
          ...
          cheat, or any type misguide any employees by their posts on Med HR Plus
          ...
          required information not update on Med HR Plus website. Med HR Plus is just
